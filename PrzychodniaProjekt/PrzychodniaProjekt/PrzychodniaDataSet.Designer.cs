...
namespace PrzychodniaProjekt.PrzychodniaDataSetTableAdapters {
...
SELECT id_pac, Imie, nazwisko, PESEL, id_adresu FROM Patient WHERE (id_pac = @id_pac)";
        ...
        public virtual int Fill(PrzychodniaDataSet.PatientDataTable dataTable) {
        ...
        public virtual PrzychodniaDataSet.PatientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PrzychodniaDataSet.PatientDataTable dataTable = new PrzychodniaDataSet.PatientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PrzychodniaDataSet.PatientDataTable dataTable) {
